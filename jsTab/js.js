...
(function(w) {
    ...
    var Tab = function(elem, config) {
        ...
        var that = this;
        that.extendConfig = extendConfig;
        this.li = document.getElementById(elem).getElementsByTagName('li');
        console.log(this.li)
        if(extendConfig.triggerType == 'click'){
